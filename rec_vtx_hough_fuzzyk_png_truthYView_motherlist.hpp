...
struct rec_vtx_hough_fuzzyk_png_truthYView_motherlist {
    ...
    static std::tuple<
            ...
            std::vector<unsigned>,
            std::vector<unsigned>,
            std::vector<rec_vtx_hough_fuzzyk_png_truthYView_motherlist>
        ...
        herr_t err;
        int ndims;
        std::vector<rec_vtx_hough_fuzzyk_png_truthYView_motherlist> content;
        std::vector<unsigned> col_run;
        std::vector<unsigned> col_subrun;
        std::vector<unsigned> col_evt;
        ...
        for(uint64_t i = 0; i < dims[0]; i++) {
            ...
            content[i].rec_vtx_hough_fuzzyk_png_truthYView_motherlist_idx = col_rec_vtx_hough_fuzzyk_png_truthYView_motherlist_idx[i];
