...
struct rec_training_slicemaps {
    ...
    static std::tuple<
            ...
            std::vector<unsigned>,
            std::vector<unsigned>,
            std::vector<rec_training_slicemaps>
        ...
        herr_t err;
        int ndims;
        std::vector<rec_training_slicemaps> content;
        std::vector<unsigned> col_run;
        std::vector<unsigned> col_subrun;
        std::vector<unsigned> col_evt;
        ...
        for(uint64_t i = 0; i < dims[0]; i++) {
            ...
            content[i].rec_training_slicemaps_idx = col_rec_training_slicemaps_idx[i];
            content[i].subevt = col_subevt[i];
            content[i].slicemap = col_slicemap[i];
