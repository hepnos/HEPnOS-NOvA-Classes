...
struct rec_trk_kalman_tracks_mrbrem_lid_truthXView_daughterlist {
    ...
    static std::tuple<
            ...
            std::vector<unsigned>,
            std::vector<unsigned>,
            std::vector<rec_trk_kalman_tracks_mrbrem_lid_truthXView_daughterlist>
        ...
        herr_t err;
        int ndims;
        std::vector<rec_trk_kalman_tracks_mrbrem_lid_truthXView_daughterlist> content;
        std::vector<unsigned> col_run;
        std::vector<unsigned> col_subrun;
        std::vector<unsigned> col_evt;
        ...
        for(uint64_t i = 0; i < dims[0]; i++) {
            ...
            content[i].rec_trk_kalman_tracks_mrbrem_lid_truthXView_daughterlist_idx = col_rec_trk_kalman_tracks_mrbrem_lid_truthXView_daughterlist_idx[i];
