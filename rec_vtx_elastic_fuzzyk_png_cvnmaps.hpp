...
struct rec_vtx_elastic_fuzzyk_png_cvnmaps {
    ...
    static std::tuple<
            ...
            std::vector<unsigned>,
            std::vector<unsigned>,
            std::vector<rec_vtx_elastic_fuzzyk_png_cvnmaps>
        ...
        herr_t err;
        int ndims;
        std::vector<rec_vtx_elastic_fuzzyk_png_cvnmaps> content;
        std::vector<unsigned> col_run;
        std::vector<unsigned> col_subrun;
        std::vector<unsigned> col_evt;
        ...
        for(uint64_t i = 0; i < dims[0]; i++) {
            ...
            content[i].rec_vtx_elastic_fuzzyk_png_cvnmaps_idx = col_rec_vtx_elastic_fuzzyk_png_cvnmaps_idx[i];
