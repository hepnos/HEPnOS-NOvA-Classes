...
struct rec_vtx_hough_fuzzyk_png_bpf_mrdif_cvn_output {
    ...
    static std::tuple<
            ...
            std::vector<unsigned>,
            std::vector<unsigned>,
            std::vector<rec_vtx_hough_fuzzyk_png_bpf_mrdif_cvn_output>
        ...
        herr_t err;
        int ndims;
        std::vector<rec_vtx_hough_fuzzyk_png_bpf_mrdif_cvn_output> content;
        std::vector<unsigned> col_run;
        std::vector<unsigned> col_subrun;
        std::vector<unsigned> col_evt;
        ...
        for(uint64_t i = 0; i < dims[0]; i++) {
            ...
            content[i].rec_vtx_hough_fuzzyk_png_bpf_mrdif_cvn_output_idx = col_rec_vtx_hough_fuzzyk_png_bpf_mrdif_cvn_output_idx[i];
